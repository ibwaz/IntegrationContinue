<%@page import="PassagersMetro.passagers"%>
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	ArrayList<passagers> cus = passagers.lstpassag();
	ArrayList<ligne> ls = ligne.lstligne();
	passagers s = new passagers();
	...
	int id_p = Integer.parseInt(articles[1]);
	if (action.equals("fiche")) {
		s = new passagers(id_p);
		s.fiche();
	}
%>
...
<title>Project 9 - Gestion Passagers</title>
</head>
<body>
	...
	<form action='c_passagers' method='post'>
		...
		<div class='container ' style="width: 40%;">
			<div class="form-group">
				<label>Id Passagers </label> <input type="text"
					class="form-control" name="c_id" value="<%=s.getId_p()%>" required>
			</div>
			<div class="form-group">
				<label>Nombre Passagers </label> <input type="text"
					class="form-control" name="c_nbr" value="<%=s.getNombre()%>">
			</div>
			<div class="form-group">
	...
	<div class='container' style="width: 40%;">
		<table class='table'>
			...
			<tbody>
				...
				%>
				<tr>
					<td colspan="3" class="w3-center w3-red">Pas de Passagers à
						afficher..</td>
